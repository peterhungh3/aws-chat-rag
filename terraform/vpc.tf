...
# NAT Gateways
# Dev: Single NAT Gateway in first AZ (saves ~$32.50/month)
# Prod: One NAT Gateway per AZ for true HA
...
# Dev: All private subnets route to single NAT Gateway
# Prod: Each private subnet routes to its local NAT Gateway (same AZ)
